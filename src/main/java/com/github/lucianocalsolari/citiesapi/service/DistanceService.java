package com.github.lucianocalsolari.citiesapi.service;
...
import com.github.lucianocalsolari.citiesapi.cities.City;
import com.github.lucianocalsolari.citiesapi.repository.CityRepository;
import com.github.lucianocalsolari.citiesapi.utils.StringLocationUtils;
...
public class DistanceService {
	...
	public Double distanceByPointsInMiles(final Long city1,final Long city2) {
		log.info("nativaePostgresInMiles({},{})", city1,city2);
		return cityRepository.distanceByPoints(city1,city2)
	}
			
	public Double distanceUsingPoints(final Long city1, final Long city2, final Long EathRadius unit) {
		log.info("distanceUsingPoints({},{},{})", city1, city2, unit);

		final List<City> cities = cityRepository.findAllById(Arrays.asList(city1,city2));

		Point p1 = citie.get(0).getLocation();
	...
	private double doCalculation(final double lat1, final double lon1,final double lat2, final double lon2, final EarthRadius earthRadius) {
		double lat = toRadians(lat2 - lat1);
		double lon = toRadians(lon1 - lon2);
