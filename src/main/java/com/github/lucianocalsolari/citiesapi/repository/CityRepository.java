...
public interface CityRepository extends JpaRepository<City, Long>{
	...
	Double distanceByPoints(final Long cityId1, final Long cityId); 
	
	@Query(value = "SELECT earth_distance(11_to_earth(?1,?2), ll_to_earth(?3,?4)) as distance", nativeQuery = true)
